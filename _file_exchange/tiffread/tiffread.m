...
while  ifd_pos ~= 0 
    ...
    for inx = 1:num_entries
        ...
        switch entry_tag
            ...
            case 266 % 266	010A	FillOrder	The logical order of bits within a byte.	Baseline
                % Do nothing
            case 280 % 280	0118	MinSampleValue	The minimum component value used.	Baseline
                % Do nothing
            case 281 % 281	0119	MaxSampleValue	The maximum component value used.	Baseline	
                % Do nothing
            case 286 % 286	011E	XPosition	X position of the image.	Extended
                % Do nothing
            case 287 % 287	011F	YPosition	Y position of the image.	Extended
                % Do nothing
            case 297 % 297	0129	PageNumber	The page number of the page from which this image was scanned.	Extended	Also used by HD Photo
                % Do nothing
            otherwise
